...
\mybox{0.8\textwidth}{\begin{prob}  \begin{itemize} Calculate the following sums and products:		\item $\sum_{k=1}^{n}\left(\frac{1}{k(k+1)}\right)$. 
								\item $\displaystyle \prod_{k=2}^{n}\left(1-\frac{1}{k^2}\right)$. 
								\item $\sum_{k=1}^{2004}\left(\frac{k}{(k+1)!}\right)$.
								\item $\displaystyle \prod_{n=1}^{\infty}\left(3^{\frac{n}{3^n}}\right)$.
