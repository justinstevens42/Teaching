...
\mybox{0.8\textwidth}{\begin{theorem} The number of powers of a prime $p$ that divide into $n!$ is $$v_p(n!)=\sum_{k=1}^{\infty}\left(\lfloor \frac{n}{p^k} \rfloor\right).$$   \end{theorem}}
...
In the case of the sum above, $$\sum_{k=1}^{\infty}\left(\lfloor \frac{n}{p^k} \rfloor\right)=\lfloor \frac{n}{p^1}\rfloor+\lfloor \frac{n}{p^2}\rfloor+\lfloor \frac{n}{p^3} \rfloor+\lfloor \frac{n}{p^4} \rfloor+\cdots.$$  
...
\mybox{0.9\textwidth}{\begin{prob}  Find the quotient and remainder when we divide $z=-1+4i$ by $w=1+2i$ in $\mathbb{Z}[i]$.  \end{prob}}
...
%find number of ways for xyz=144.  
