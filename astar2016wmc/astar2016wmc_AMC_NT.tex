...
\mybox{0.8\textwidth}{\begin{prob}[AHSME 1996] If $n$ is a positive integer such that $2n$ has $28$ positive divisors and $3n$ has $30$ positive divisors, then how many positive divisors does $6n$ have? \end{prob} \begin{prob} Find the number of positive integer solutions $(x,y,z)$ for which $xyz=480$. \end{prob}}
